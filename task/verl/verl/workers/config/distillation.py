    ...
    def _validate_topk_logprobs(self, use_topk: bool, topk: Optional[int]) -> None:
        ...
        match engine_name:
            case "sglang":
                ...
                # engine-boot cap to align. The async server translates
                # sampling_params["prompt_logprobs"] into return_logprob +
                # logprob_start_len=0 + top_logprobs_num at call time.
                pass
            case _:
                raise NotImplementedError(
