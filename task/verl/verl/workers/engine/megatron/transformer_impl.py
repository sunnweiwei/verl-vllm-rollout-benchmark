...
from verl.utils.megatron_peft_utils import add_base_layer_suffix, build_peft_config_for_inference
...
class MegatronEngine(BaseEngine):
    ...
    def get_per_tensor_param(self, base_sync_done=False, **kwargs):
        ...
        if non_merge_lora_sync:
            peft_config = build_peft_config_for_inference(self.model_config.lora)
        ...
        # QAT: process weights through QATWeightExporter for quantized weight sync.
        if self._qat_enabled:
