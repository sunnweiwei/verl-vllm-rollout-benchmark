...
def compute_spec_decode_metrics(
    ...
    The three inputs come from rollout engine speculative decoding stats.
    Either all three are ``None``
...
class RayPPOTrainer:
    ...
    Supports various model architectures and rollout engine integrations.
    """
    ...
    def init_workers(self):
        ...
        # Create rollout at the end so the inference engine can estimate KV cache memory.
        ...
        for epoch in range(current_epoch, self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                if self.config.algorithm.adv_estimator == AdvantageEstimator.REMAX:
                    ...
                    # Keep them in a single agent-loop request to avoid sending a second
                    # rollout after replicas have been put to sleep, which can leave async
